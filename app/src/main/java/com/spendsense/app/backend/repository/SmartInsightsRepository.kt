...
class SmartInsightsRepository {
    ...
    suspend fun getThreeActionableTips(expenses: List<ExpenseEntity>): List<String> {
        ...
        return listOf(
            "Your spending in '$topCategory' is higher than last month. Consider tactical reductions.",
            "Switch to 'Cash' for minor transactions to reduce impulsive spending.",
            "40% of your expenses occur on weekends. Deploy a 'No-Spend Saturday' protocol to boost balance."
        )
    }
